...
namespace p6
{
	...
	private:
		...
		bool _area_select_draw = false;	///<Indicator if area selection needs to be drawn
		bool _grid_draw = false;		///<Indicator if grid needs to be drawn
	...
	public:
		...
		Coord center = Coord(0.0, 0.0);								///<Coordinates of view center
